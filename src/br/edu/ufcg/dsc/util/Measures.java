 ...
 * 
 * <strong><p>Esta classe � respons�vel por calcular o tempo necess�rio para realizar determinadas tarefas
 *  ao avaliar a evolu��o da LPS. Como por exemplo:<br></br>
...
public class Measures {
	...
	/**Nome resultante do arquivo para gerar o relat�rio.*/
	private String fileResultName;
	
	/**Vari�vel usada para armazenar o tempo corrente em milisegundos.*/
	private String execucao;
	
	/**Arquivo de propriedades*/
	private String filePropertiesName;
	
	/**Vari�vel boolena para determinar se houve refinamento ou n�o na Evolu��o da LPS.*/
